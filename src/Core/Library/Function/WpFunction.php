<?php
	...
	if ( ! class_exists( '\Ababilitworld\FlexCoreByAbabilitworld\Core\Library\Function\WpFunction' ) ) 
	{
		class WpFunction 
		{
		 ...
		 * Return the instance
		 *
		 * @return Ababilitworld\FlexCoreByAbabilitworld\Core\Library\Function\WpFunction
		 */
		function wp_function() 
		{
			return WpFunction::instance();
		}
